# Diabetes Risk Prediction — Data Analysis & Classification
...
The CSV is not included in this repo (3.8 MB, easily can be downloaded from Kaggle). Download it and place it in the project root as `diabetes_prediction_dataset.csv` to run the notebook.
